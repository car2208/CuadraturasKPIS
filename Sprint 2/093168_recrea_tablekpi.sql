...
/*
 select 1 from
  ...
  select count(*) as cant1,
         (select count(*) from ${BD_DQ}.T11908DETKPITRIBINT_old) as cant2 
  from  ${BD_DQ}.T11908DETKPITRIBINT
  )
  x where x.cant1=x.cant2

.IF activitycount = 0 THEN .GOTO indj0
.IF activitycount = 1 THEN .GOTO indj1 

${BD_DQ}.T11908DETKPITRIBINT

${BD_DQ}.T11908DETKPITRIBINT_OLD;
...
DROP TABLE ${BD_DQ}.T11908DETKPITRIBINT_OLD;
.IF ERRORCODE <> 0 THEN .GOTO error_shell; 
