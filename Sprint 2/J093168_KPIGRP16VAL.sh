...
### $6 : Ruta Log TERADATA
### $7 : Periodo :2022
### sh /work1/teradata/shell/093168/J093168_KPIGRP16VAL.sh tdsunat usr_carga_prod twusr_carga_prod bddwedq bddwestg /work1/teradata/log/093168 2022
### sh /work1/teradata/shell/093168/J093168_KPIGRP16VAL.sh tdtp01s2 usr_carga_desa twusr_carga_desa bddwedqd bddwestgd /work1/teradata/log/093168 2022
...
AND a.ind_archpers = '1'  
AND a.ind_est_archpers <> '0'
AND a.ind_est_formvirt= '0'  -- personalizado
AND a.fec_comprob >= CAST('${PERIODO}-01-01' AS DATE FORMAT 'YYYY-MM-DD')
AND a.fec_comprob <= CAST('${PERIODO}-12-31' AS DATE FORMAT 'YYYY-MM-DD')
) WITH DATA NO PRIMARY INDEX;
