...
/********************INSERT EN TABLA FINAL***********************************/
 ...
 FROM
  (
   SELECT
          x0.ind_presdj,
          case when x0.ind_presdj=0 then (select sum(mto_deduc_origen) from BDDWESTG.tmp093168_kpigr15_cnorigen) else 0 end as mto_origen,
 ...
 FROM
  (
   SELECT x0.ind_presdj,
          ...
          case when x0.ind_presdj=0  then (select sum(mto_deduc_destino2) from BDDWESTG.tmp093168_kpigr15_cndestino2) else 0 end AS mto_destino
