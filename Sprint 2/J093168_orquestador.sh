...
if [ $# -ne 12 ]; then echo 'Numero incorrecto de Parametros'; exit 1; fi
...
sh ${path_shell_TD}/J093168_KPIGRP10.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1}
...
sh ${path_shell_TD}/J093168_KPIGRP11.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1}
...
sh ${path_shell_TD}/J093168_KPIGRP12.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1}
...
sh ${path_shell_TD}/J093168_KPIGRP018.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP019.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP022.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP023.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP024.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP025.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
