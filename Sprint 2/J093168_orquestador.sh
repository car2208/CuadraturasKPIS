...
sh ${path_shell_TD}/J093168_KPIGRP02.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1}
...
sh ${path_shell_TD}/J093168_KPIGRP03.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1}
...
sh ${path_shell_TD}/J093168_KPIGRP04.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1}
...
sh ${path_shell_TD}/J093168_KPIGRP11.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP12.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_SP1} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP13.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} 
...
sh ${path_shell_TD}/J093168_KPIGRP14OBS.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP15.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP16VAL.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP16OBS.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP17.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} 
...
sh ${path_shell_TD}/J093168_KPIGRP018.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP019.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP020.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP021.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP022.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP023.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP024.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP025.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO} ${FECHA_FV}
...
sh ${path_shell_TD}/J093168_KPIGRP2627.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${path_log_TD} ${PERIODO}
...
sh ${path_shell_TD}/J093168_KPIGRP36.sh ${server_TD} ${username_TD} ${walletPwd_TD} ${BD_DQ} ${BD_STG} ${BD_TB} ${DW_DATA} ${path_log_TD} ${PERIODO} ${FECHA_SP2}
