...
/********************INSERT EN TABLA FINAL***********************************/
 ...
 SELECT 
   ...
   case when x0.ind_presdj=0 then 
    case when (select count(*) from BDDWESTG.tmp093168_dif_K014012022)=0 then 1 else 0 end 
   end as ind_incuniv,
 ...
 SELECT 
   ...
   case when x0.ind_presdj=0 then 
   case when (select count(*) from BDDWESTG.tmp093168_dif_K014022022)=0 then 1 else 0 end 
   end as ind_incuniv,
