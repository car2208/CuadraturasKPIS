...
DROP TABLE BDDWESTGD.tmp093168_udjkpigr4;

CREATE MULTISET TABLE BDDWESTGD.tmp093168_udjkpigr4 as
(
...
DROP TABLE BDDWESTGD.tmp093168_kpigr4_periodos_ctaind;

CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr4_periodos_ctaind as
(
  SELECT  DISTINCT 
        x0.num_docide_aseg,
        x0.num_docide_empl,
...
INNER JOIN  BDDWESTGD.tmp093168_udjkpigr4 x1 
...
DROP TABLE BDDWESTGD.tmp093168_kpigr04_detcnt_tr;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_detcnt_tr AS
(
   SELECT
        ...
        num_orden,
        per_aporta
   FROM BDDWESTGD.tmp093168_kpigr4_periodos_ctaind
)
WITH DATA NO PRIMARY INDEX;
...
DROP TABLE BDDWESTGD.tmp093168_kpigr04_detcntpertr;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_detcntpertr
AS(
SELECT 
    DISTINCT x0.num_ruc,
    COALESCE(x1.ind_presdj,0) as ind_presdj,
        ...
        x0.num_orden,
        x0.per_aporta
FROM BDDWESTGD.tmp093168_kpigr04_detcnt_tr x0
...
DROP TABLE BDDWESTGD.tmp093168_kpigr04_detcntperfv;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_detcntperfv
AS(
...
DROP TABLE BDDWESTGD.tmp093168_kpigr04_detcntpermdb;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_detcntpermdb
AS(
  SELECT DISTINCT x1.num_ruc,COALESCE(x1.ind_presdj,0) as ind_presdj,
...
DROP TABLE BDDWESTGD.tmp093168_kpigr04_cnorigen;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_cnorigen AS
(
  SELECT ind_presdj,count(per_aporta) as cant_per_origen
  FROM BDDWESTGD.tmp093168_kpigr04_detcntpertr
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;

---------2. Conteo en FVirtual
DROP TABLE BDDWESTGD.tmp093168_kpigr04_cndestino1;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_cndestino1 AS
(
  SELECT ind_presdj,count(periodo) as cant_per_destino1
  FROM BDDWESTGD.tmp093168_kpigr04_detcntperfv
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;

--------3 Conteo en MongoDB
DROP TABLE BDDWESTGD.tmp093168_kpigr04_cndestino2 ;
CREATE MULTISET TABLE BDDWESTGD.tmp093168_kpigr04_cndestino2 AS
(
  SELECT ind_presdj,count(num_perservicio) as cant_per_destino2
  FROM BDDWESTGD.tmp093168_kpigr04_detcntpermdb
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;
...
/********************INSERT EN TABLA FINAL***********************************/
  ...
  WHERE COD_KPI='KPI0007022' AND FEC_CARGA=CURRENT_DATE;
  ...
  FROM
    (
      ...
      FROM BDDWESTGD.tmp093168_kpigr04_cnorigen x0
      LEFT JOIN BDDWESTGD.tmp093168_kpigr04_cndestino1 x1 
  ...
  DELETE FROM BDDWEDQD.TXXXXDETKPITRIBINT 
  WHERE COD_KPI='KPI0008022' AND FEC_CARGA=CURRENT_DATE;
  ...
  FROM
    (
      ...
      FROM BDDWESTGD.tmp093168_kpigr04_cndestino1 x0
      LEFT JOIN BDDWESTGD.tmp093168_kpigr04_cndestino2 x1 
      ON x0.ind_presdj=x1.ind_presdj
    ) z
  GROUP BY 1,2,3,4
  ;
...
SELECT 
    ...
    y0.ind_presdj,
        ...
        y0.num_orden,
        y0.per_aporta
  FROM BDDWESTGD.tmp093168_kpigr04_detcntpertr y0
  INNER JOIN
  (
...
select * from BDDWEDQD.TXXXXDETKPITRIBINT 
