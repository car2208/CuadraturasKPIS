...
FROM BDDWESTG.t1209f616rddet x0, BDDWESTG.tmp093168_udjkpi1 x1
...
(
	SELECT num_ruc,num_serie,cod_tipcomp,num_comprob FROM BDDWESTG.tmp093168_cantrecibos
	UNION
	SELECT num_docide_dec,num_serie_cp,tip_cp,num_cp FROM BDDWESTG.tmp093168_cantrecibosf616
)
WITH DATA NO PRIMARY INDEX;
...
AS(
	...
	LEFT JOIN BDDWESTG.tmp093168_kpiperindj x1 ON x0.num_sec = x1.num_sec
