/*
DROP TABLE BDDWESTG.tmpPilot093168_udjkpigr4;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr4_periodos_ctaind;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcnt_tr;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntpertr;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntperfv;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntpermdb;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_cnorigen;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_cndestino1;
DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_cndestino2;
drop TABLE BDDWESTG.DIF_K004P12022;
drop TABLE BDDWESTG.DIF_K004P22022;
*/
/************Obtiene úlima DJ ***********************************************/

--DROP TABLE BDDWESTG.tmpPilot093168_udjkpigr4;

CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_udjkpigr4 as
(
...
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr4_periodos_ctaind as
(
  SELECT  DISTINCT 
...
INNER JOIN  BDDWESTG.tmpPilot093168_udjkpigr4 x1 
...
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcnt_tr;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_detcnt_tr AS
(
   SELECT
        ...
        num_orden,
        per_aporta
   FROM BDDWESTG.tmpPilot093168_kpigr4_periodos_ctaind
)
WITH DATA NO PRIMARY INDEX;
...
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntpertr;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntpertr
AS(
SELECT 
    DISTINCT x0.num_ruc,
    COALESCE(x1.ind_presdj,0) as ind_presdj,
        ...
        x0.num_orden,
        x0.per_aporta
FROM BDDWESTG.tmpPilot093168_kpigr04_detcnt_tr x0
...
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntperfv;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntperfv
AS(
...
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntpermdb;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_detcntpermdb
AS(
  SELECT DISTINCT x1.num_ruc,COALESCE(x1.ind_presdj,0) as ind_presdj,
...
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_cnorigen;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_cnorigen AS
(
  SELECT ind_presdj,count(per_aporta) as cant_per_origen
  FROM BDDWESTG.tmpPilot093168_kpigr04_detcntpertr
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;

---------2. Conteo en FVirtual
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_cndestino1;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_cndestino1 AS
(
  SELECT ind_presdj,count(periodo) as cant_per_destino1
  FROM BDDWESTG.tmpPilot093168_kpigr04_detcntperfv
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;

--------3 Conteo en MongoDB
--DROP TABLE BDDWESTG.tmpPilot093168_kpigr04_cndestino2 ;
CREATE MULTISET TABLE BDDWESTG.tmpPilot093168_kpigr04_cndestino2 AS
(
  SELECT ind_presdj,count(num_perservicio) as cant_per_destino2
  FROM BDDWESTG.tmpPilot093168_kpigr04_detcntpermdb
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;
...
/********************INSERT EN TABLA FINAL***********************************/
  ...
  WHERE COD_KPI='K004P12022' AND FEC_CARGA=CURRENT_DATE;
  ...
  FROM
    (
      SELECT
             x0.ind_presdj,
             case when x0.ind_presdj=0 then (select coalesce(sum(cant_per_origen),0) from BDDWESTG.tmpPilot093168_kpigr04_cnorigen) else 0 end as cant_origen,
      ...
      (
          ...
          from
          (
            select * from BDDWESTG.tmpPilot093168_kpigr04_cnorigen
            union all select 1,0 from (select '1' agr1) a
            union all select 0,0 from (select '0' agr0) b
          ) y group by 1
      ) x0
      LEFT JOIN BDDWESTG.tmpPilot093168_kpigr04_cndestino1 x1 
  ...
  DELETE FROM BDDWESTG.T11908DETKPITRIBINT 
  WHERE COD_KPI='K004P22022' AND FEC_CARGA=CURRENT_DATE;
  ...
  FROM
    (
     SELECT x0.ind_presdj,
             ...
             case when x0.ind_presdj=0  then (select coalesce(sum(cant_per_destino2),0) from BDDWESTG.tmpPilot093168_kpigr04_cndestino2) else 0 end AS cant_destino
      FROM 
      (
         select y.ind_presdj,SUM(y.cant_per_destino1) as cant_per_destino1
          from
          (
            select * from BDDWESTG.tmpPilot093168_kpigr04_cndestino1
            union all select 1,0 from (select '1' agr1) a
            union all select 0,0 from (select '0' agr0) b
          ) y group by 1
      ) x0
      LEFT JOIN BDDWESTG.tmpPilot093168_kpigr04_cndestino2 x1 
      ON x0.ind_presdj=x1.ind_presdj
    ) z
  GROUP BY 1,2,3,4
  ;
...
/********************************************************************************************/
 ...
 CREATE MULTISET TABLE BDDWESTG.DIF_K004P12022
  AS
  (
  SELECT 
  ...
  FROM BDDWESTG.tmpPilot093168_kpigr04_detcntpertr y0
  INNER JOIN
  (
  ...
  AND SUBSTR(y0.per_aporta,5,2)||SUBSTR(y0.per_aporta,1,4)=y1.per_aporta
   ...
   CREATE MULTISET TABLE BDDWESTG.DIF_K004P22022
  AS
  (
