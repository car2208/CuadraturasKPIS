--DROP TABLE BDDWESTG.tmpPilotRu093168_udjkpigr3;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr3_periodos_compag;
--DROP TABLE BDDWESTG.tmpPilotRu093168_udj_f616_kpigr3;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr3_periodos_f0616;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcnt_tr;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntpertr;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntperfv;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntpermdb;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cnorigen;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cndestino1;
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cndestino2 ;
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_udjkpigr3;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_udjkpigr3 as
(
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr3_periodos_compag;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr3_periodos_compag AS
(
  ...
  INNER JOIN BDDWESTG.tmpPilotRu093168_udjkpigr3 x1 
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_udj_f616_kpigr3;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_udj_f616_kpigr3 as
(
 SELECT 
        num_nabono as t03nabono,
        num_orden as t03norden,
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr3_periodos_f0616;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr3_periodos_f0616 as
(
  SELECT  DISTINCT x0.num_docide_dec,
          ...
          x0.norden as num_orden,
          x0.per_periodo 
  FROM BDDWESTG.t1209f616rddet x0, BDDWESTG.tmpPilotRu093168_udj_f616_kpigr3 x1
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcnt_tr;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcnt_tr AS
(
 ...
 SELECT  TRIM(num_docide_dec) as num_ruc,
  ...
  FROM BDDWESTG.tmpPilotRu093168_kpigr3_periodos_f0616
  UNION
  SELECT 
         TRIM(num_rucs),
         ...
         num_orden,
         per_decla
  FROM BDDWESTG.tmpPilotRu093168_kpigr3_periodos_compag
)WITH DATA NO PRIMARY INDEX;
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntpertr;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntpertr
AS(
SELECT 
    DISTINCT x0.num_ruc,
    COALESCE(x1.ind_presdj,0) as ind_presdj,
        ...
        x0.num_orden,
        x0.per_decla
FROM BDDWESTG.tmpPilotRu093168_kpigr03_detcnt_tr x0
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntperfv;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntperfv
AS
(
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntpermdb;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_detcntpermdb
AS(
  SELECT DISTINCT x1.num_ruc,COALESCE(x1.ind_presdj,0) as ind_presdj,
...
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cnorigen;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cnorigen AS
(
  SELECT ind_presdj,count(per_decla) as cant_per_origen
  FROM BDDWESTG.tmpPilotRu093168_kpigr03_detcntpertr
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;

---------2. Conteo en FVirtual
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cndestino1;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cndestino1 AS
(
  SELECT ind_presdj,count(periodo) as cant_per_destino1
  FROM BDDWESTG.tmpPilotRu093168_kpigr03_detcntperfv
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;

--------3 Conteo en MongoDB
--DROP TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cndestino2 ;
CREATE MULTISET TABLE BDDWESTG.tmpPilotRu093168_kpigr03_cndestino2 AS
(
  SELECT ind_presdj,count(num_perservicio) as cant_per_destino2
  FROM BDDWESTG.tmpPilotRu093168_kpigr03_detcntpermdb
  GROUP BY 1
) WITH DATA NO PRIMARY INDEX;
  ...
  FROM
    (
      SELECT
             x0.ind_presdj,
              case when x0.ind_presdj=0 then 
                      (select coalesce(sum(cant_per_origen),0) from BDDWESTG.tmpPilotRu093168_kpigr03_cnorigen) 
      ...
      FROM (
          ...
          from
          (
            select * from BDDWESTG.tmpPilotRu093168_kpigr03_cnorigen
            union all select 1,0 from (select '1' agr1) a
            union all select 0,0 from (select '0' agr0) b
          ) y group by 1

      ) x0
      LEFT JOIN BDDWESTG.tmpPilotRu093168_kpigr03_cndestino1 x1 
  ...
  FROM
    (
      SELECT x0.ind_presdj,
             ...
             case when x0.ind_presdj=0  then 
                      (select coalesce(sum(cant_per_destino2),0) from BDDWESTG.tmpPilotRu093168_kpigr03_cndestino2)
             else 0 end AS cant_destino
      FROM (
          select y.ind_presdj,SUM(y.cant_per_destino1) as cant_per_destino1
          from
          (
            select * from BDDWESTG.tmpPilotRu093168_kpigr03_cndestino1
            union all select 1,0 from (select '1' agr1) a
            union all select 0,0 from (select '0' agr0) b
          ) y group by 1
      ...
      LEFT JOIN BDDWESTG.tmpPilotRu093168_kpigr03_cndestino2 x1 
      ON x0.ind_presdj=x1.ind_presdj
    ) z
  GROUP BY 1,2,3,4
  ;
...
DROP TABLE BDDWESTG.DIF_K003P12022;
  ...
  (
    ...
    FROM BDDWESTG.tmpPilotRu093168_kpigr03_detcntpertr y0
    INNER JOIN
    (
