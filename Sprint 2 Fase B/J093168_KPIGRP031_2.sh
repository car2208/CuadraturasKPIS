...
### $12 : Ruta log shell
### $13 : PERIODO
##  sh /work1/teradata/shells/093168/J093168_KPIGRP031_2.sh serverifx bdifx userifx passwordifx pathifx tdsunat usr_carga_prod twusr_carga_prod BDDWEDQ BDDWESTG BDDWETB /work1/teradata/log/093168 2022
##  sh /work1/teradata/shells/093168/J093168_KPIGRP031_2.sh serverifx bdifx userifx passwordifx pathifx tdtp01s2 usr_carga_desa twusr_carga_desa BDDWEDQD BDDWESTGD BDDWETBD /work1/teradata/log/093168 2022
################################################################################
...
plano=${path_log_TD}'/tmp093168_'${KPI_01}'_t1391f695extitf.unl'
...
###=====================================================================================================
###**********************************Cantidad de registros Informix t1391f695extitf**********************
###=====================================================================================================
...
select count(1) as cnt_reg from t1391f695extitf
...
SELECT 1 FROM  dbc.TablesV WHERE databasename = '${BD_STG}' AND TableName = 'tmp093168_kpigr31_02_cantorigen';
.IF activitycount = 0 THEN .GOTO ok 
DROP TABLE ${BD_STG}.tmp093168_kpigr31_02_cantorigen;
.IF ERRORCODE <> 0 THEN .GOTO error_shell;
.label ok;


CREATE MULTISET TABLE ${BD_STG}.tmp093168_kpigr31_02_cantorigen
(
